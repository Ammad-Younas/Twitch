...
import com.madiwist.twitch.feature_post.domain.use_case.GetPostModificationsUseCase
...
object PostModule {
    ...
    fun providePostUserCase(repository: PostRepository) : PostUseCases{
        return PostUseCases(
            ...
            getPostModificationsUseCase = GetPostModificationsUseCase(repository),
            getCommentModificationsUseCase = GetCommentModificationsUseCase(repository)
        )
    }
}